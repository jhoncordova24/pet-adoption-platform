                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-wrapper">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($_SESSION['id_rol'] == 3 && $fila['id_rol'] != 3) {
                                                        ...
                                                        ?>
                                                        <a class="edit" href="editar_usuario.php?id=<?php echo $fila['id_usuario']; ?>" data-toggle="tooltip" title="Edit">
                                                            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                                                        </a>
                                                        <a class="delete" href="eliminar_usuario.php?id=<?php echo $fila['id_usuario']; ?>" data-toggle="tooltip" title="Delete">
                                ...
                                <!-- Paginación -->
                                <div class="clearfix">
                                    <div class="hint-text">Mostrando <b><?php echo min(count($resultados), $registros_por_pagina); ?></b> de <b><?php echo $total_registros; ?></b></div>
                                    <ul class="pagination">
