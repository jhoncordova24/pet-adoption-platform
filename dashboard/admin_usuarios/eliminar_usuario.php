...
if (isset($_POST['ids'])) {
    ...
    $consulta = "DELETE FROM usuario WHERE id_usuario IN ($idList)";
    if (mysqli_query($conn, $consulta)) {
        echo "Usuarios eliminados correctamente.";
    } else {
        echo "Error al eliminar los usuarios: " . mysqli_error($conn);
    }
}
?>
    ...
    <body>
        ...
        <script>
            function handleSubmit() {
                alert("El usuario ha sido ELIMINADO. Serás redirigido a la página de administración de usuarios.");
                window.location.href = "../../dashboard/indexUsuarios.php";
            }
        </script>
